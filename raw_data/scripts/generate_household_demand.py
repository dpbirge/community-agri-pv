...
def load_housing_data():
    """Load housing energy and water baseline data."""
    housing_path = get_project_root() / "data/parameters/community/housing_energy_water-toy.csv"
    ...
    return pd.read_csv(housing_path, skiprows=header_idx)
...
def generate_household_demand():
    ...
    # Base energy and water values per household type
    small_base_kwh = housing[housing["category"] == "small_household"]["kwh_per_household_per_day"].values[0]
    medium_base_kwh = housing[housing["category"] == "medium_household"]["kwh_per_household_per_day"].values[0]
    large_base_kwh = housing[housing["category"] == "large_household"]["kwh_per_household_per_day"].values[0]

    small_base_m3 = housing[housing["category"] == "small_household"]["m3_per_household_per_day"].values[0]
    medium_base_m3 = housing[housing["category"] == "medium_household"]["m3_per_household_per_day"].values[0]
    large_base_m3 = housing[housing["category"] == "large_household"]["m3_per_household_per_day"].values[0]
    ...
    # Write output files
    output_dir = get_project_root() / "data/precomputed/household"
...
# DEPENDENCIES: daily_weather_scenario_001-toy.csv, housing_energy_water-toy.csv
